...
<html lang="zxx">
  ...
  <body>
            ...
            <ul>
              ...
              <li class="drop-down">
                ...
                <ul>
                  ...
                  <li class="active"><a href="kitchen.html">Kitchen</a></li>
    ...
    <!-- Hero Section Begin -->
    <section class="hero-section kitchen-section">
      <div class="container">
        <div class="row">
          <div class="col-lg-6">
            <div class="hero-text about_hero_text">
              ...
              <a href="#menu" class="btn kitchen-btn">Our Menu</a>
              <a href="#book-a-table" class="btn kitchen-btn">Book a Table</a>
            </div>
          </div>
        </div>
      </div>
      <div class="hero-slider owl-carousel">
        <div
          class="hs-item kitchen-bg set-bg"
          data-setbg="img/kitchen/hero-bg.jpg"
        ></div>
      ...
      <div class="container" data-aos="fade-up">
        ...
        <div class="row menu-container" data-aos="fade-up" data-aos-delay="200">
          <div class="col-lg-6 menu-item filter-starters">
            <div class="img-box">
              <img
                src="./img/kitchen/menu/lobster-bisque.jpg"
            ...
            <div class="content">
              <div class="menu-content">
                <a href="#">Lobster Bisque</a> <br /><span>$5.95</span>
              </div>
          ...
          <div class="col-lg-6 menu-item filter-specialty">
            <div class="img-box">
              <img
                src="./img/kitchen/menu/bread-barrel.jpg"
                class="menu-img img-fluid"
                alt=""
              />
            </div>
            <div class="content">
              <div class="menu-content">
                <a href="#">Bread Barrel</a><br /><span>$6.95</span>
              </div>
              <div class="menu-ingredients">
                Lorem, deren, trataro, filede, nerada
              </div>
          ...
          <div class="col-lg-6 menu-item filter-starters">
            ...
            <div class="content">
              <div class="menu-content">
                <a href="#">Crab Cake</a><br /><span>$7.95</span>
              </div>
              <div class="menu-ingredients">
          ...
          <div class="col-lg-6 menu-item filter-salads">
            <div class="img-box position-abolute">
              <img
                src="./img/kitchen/menu/caesar.jpg"
                class="menu-img img-fluid"
                alt=""
              />
            </div>
            <div class="content">
              <div class="menu-content">
                <a href="#">Caesar Selections</a><br /><span>$8.95</span>
              </div>
              <div class="menu-ingredients">
                Lorem, deren, trataro, filede, nerada
              </div>
          ...
          <div class="col-lg-6 menu-item filter-specialty">
            <div class="img-box">
              <img
                src="./img/kitchen/menu/tuscan-grilled.jpg"
                class="menu-img img-fluid"
                alt=""
              />
            </div>
            <div class="content">
              <div class="menu-content">
                <a href="#">Tuscan Grilled</a><br /><span>$9.95</span>
              </div>
              <div class="menu-ingredients">
          ...
          <div class="col-lg-6 menu-item filter-starters">
            <div class="img-box">
              <img
                src="./img/kitchen/menu/mozzarella.jpg"
                class="menu-img img-fluid"
                alt=""
              />
            </div>
            <div class="content">
              <div class="menu-content">
                <a href="#">Mozzarella Stick</a><br /><span>$4.95</span>
              </div>
              <div class="menu-ingredients">
                Lorem, deren, trataro, filede, nerada
              </div>
          ...
          <div class="col-lg-6 menu-item filter-salads">
            <div class="img-box">
              <img
                src="./img/kitchen/menu/greek-salad.jpg"
                class="menu-img img-fluid"
                alt=""
              />
            </div>
            <div class="content">
              <div class="menu-content">
                <a href="#">Greek Salad</a><br /><span>$9.95</span>
              </div>
              <div class="menu-ingredients">
          ...
          <div class="col-lg-6 menu-item filter-salads">
            <div class="img-box">
              <img
                src="./img/kitchen/menu/spinach-salad.jpg"
                class="menu-img img-fluid"
                alt=""
              />
            </div>
            <div class="content">
              <div class="menu-content">
                <a href="#">Spinach Salad</a><br /><span>$9.95</span>
              </div>
              <div class="menu-ingredients">
          ...
          <div class="col-lg-6 menu-item filter-specialty">
            <div class="img-box">
              <img
                src="./img/kitchen/menu/lobster-roll.jpg"
                class="menu-img img-fluid"
                alt=""
              />
            </div>
            <div class="content">
              <div class="menu-content">
                <a href="#">Lobster Roll</a><br /><span>$12.95</span>
              </div>
              <div class="menu-ingredients">
          ...
          <div class="col-lg-6 menu-item filter-salads">
            <div class="img-box">
              <img
                src="./img/kitchen/menu/african.jpeg"
                class="menu-img afri_salad img-fluid"
                alt=""
              />
            </div>
            <div class="content">
              <div class="menu-content">
                <a href="#">African Salad</a> <br /><span>$5.95</span>
              </div>
              <div class="menu-ingredients">
                Lorem, deren, trataro, filede, nerada
              </div>
            ...
            <div class="tab-content">
              <div class="tab-pane active show" id="tab-1">
                <div class="row">
                  ...
                  <div class="col-lg-4 text-center order-1 order-lg-2">
                    <img
                      src="./img/kitchen/specials-1.png"
                      alt=""
                      class="img-fluid"
                    />
                  </div>
              ...
              <div class="tab-pane" id="tab-2">
                <div class="row">
                  ...
                  <div class="col-lg-4 text-center order-1 order-lg-2">
                    <img
                      src="./img/kitchen/specials-2.png"
                      alt=""
                      class="img-fluid"
                    />
                  </div>
              ...
              <div class="tab-pane" id="tab-3">
                <div class="row">
                  ...
                  <div class="col-lg-4 text-center order-1 order-lg-2">
                    <img
                      src="./img/kitchen/specials-3.png"
                      alt=""
                      class="img-fluid"
                    />
                  </div>
              ...
              <div class="tab-pane" id="tab-4">
                <div class="row">
                  ...
                  <div class="col-lg-4 text-center order-1 order-lg-2">
                    <img
                      src="./img/kitchen/specials-4.png"
                      alt=""
                      class="img-fluid"
                    />
                  </div>
              ...
              <div class="tab-pane" id="tab-5">
                <div class="row">
                  ...
                  <div class="col-lg-4 text-center order-1 order-lg-2">
                    <img
                      src="./img/kitchen/specials-5.png"
                      alt=""
                      class="img-fluid"
                    />
                  </div>

...
<html lang="en">
  ...
  <body>
    ...
    <section class="room_gallery bg-light">
      <div class="container">
        <div class="row">
          <div class="col-lg-12">
            <div class="section-title pb-3">
              <h2 class="text-uppercase">Rooms</h2>
              <p>Check out our rooms!</p>
            </div>
          </div>
        </div>
      </div>
          ...
          <div class="col-lg-6 col-md-12">
            <div class="room-wrap d-md-flex">
              <a
                href="#"
                class="img img-fluid"
                style="background-image: url(img/room/gallery/room-4.jpg)"
              ></a>
          ...
          <div class="col-lg-6 col-md-12">
            <div class="room-wrap d-md-flex">
              <a
                href="#"
                class="img img-fluid"
                style="background-image: url(img/room/gallery/room-1.jpg)"
              ></a>
              <div class="half left-arrow d-flex align-items-center">
                <div class="text p-4 p-xl-5 text-center">
                  <p class="star mb-0">
          ...
          <div class="col-lg-6 col-md-12">
            <div class="room-wrap d-md-flex">
              <a
                href="#"
                class="img img-fluid"
                style="background-image: url(img/room/gallery/room-3.jpg)"
              ></a>
              <div class="half left-arrow d-flex align-items-center">
                <div class="text p-4 p-xl-5 text-center">
                  <p class="star mb-0">
          ...
          <div class="col-lg-6 col-md-12">
            <div class="room-wrap d-md-flex">
              <a
                href="#"
                class="img img-fluid"
                style="background-image: url(img/room/gallery/room-2.jpg)"
              ></a>
              <div class="half left-arrow d-flex align-items-center">
                <div class="text p-4 p-xl-5 text-center">
                  <p class="star mb-0">
          ...
          <div class="col-lg-6 col-md-12">
            <div class="room-wrap d-md-flex">
              <a
                href="#"
                class="img img-fluid"
                style="background-image: url(img/room/gallery_rooms/room3.jpg)"
              ></a>
              <div class="half left-arrow d-flex align-items-center">
                <div class="text p-4 p-xl-5 text-center">
                  <p class="star mb-0">
          ...
          <div class="col-lg-6 col-md-12">
            <div class="room-wrap d-md-flex">
              <a
                href="#"
                class="img img-fluid"
                style="background-image: url(img/room/gallery_rooms/room5.jpg)"
              ></a>
              <div class="half left-arrow d-flex align-items-center">
                <div class="text p-4 p-xl-5 text-center">
                  <p class="star mb-0">
      ...
      <div class="container" >
        <div class="col-lg-12">
          <div class="section-title pb-4">
            <h2>Gallery</h2>
            <p>Some photos from Our Hotel</p>
          </div>
        </div>
      </div>
      ...
      <div class="container-fluid">
        <div class="row no-gutters">
          ...
          <div class="col-lg-3 col-md-4">
            <div class="gallery-item">
              <a
                href="./img/gallery/gallery5.jpeg"
                class="venobox"
                data-gall="gallery-item"
              >
                <img
          ...
          <div class="col-lg-3 col-md-4">
            <div class="gallery-item">
              <a
                href="./img/gallery/gallery8.jpeg"
                class="venobox"
                data-gall="gallery-item"
              >
                <img
          ...
          <div class="col-md-12">
            <div class="gallery-active owl-carousel">
              <div class="gallery-img">
                <a href="#"
                  ><img src="./img/room/gallery_rooms/room1.jpg" alt=""
                /></a>
              </div>
              <div class="gallery-img">
                <a href="#"
                  ><img src="./img/room/gallery_rooms/room2.jpg" alt=""
                /></a>
              </div>
              <div class="gallery-img">
                <a href="#"
                  ><img src="./img/room/gallery_rooms/room3.jpg" alt=""
                /></a>
              </div>
              <div class="gallery-img">
                <a href="#"
                  ><img src="./img/room/gallery_rooms/room4.jpg" alt=""
                /></a>
              </div>
              <div class="gallery-img">
                <a href="#"
                  ><img src="./img/room/gallery_rooms/room5.jpg" alt=""
                /></a>
              </div>
              <div class="gallery-img">
                <a href="#"
                  ><img src="./img/room/gallery_rooms/room6.jpg" alt=""
                /></a>
              </div>
            </div>
          </div>

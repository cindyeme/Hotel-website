...
<html lang="en">
  ...
  <body>
    ...
    <!-- ======= Events Section ======= -->
    <section id="events" class="events bg-light">
      <div class="container" data-aos="fade-up">

        <div class="col-lg-12">
          <div class="section-title">
            <h2>Events</h2>
            <p>Organize Your Events in our Hotels</p>
          </div>
        </div>
        ...
        >
          <div class="row event-item">
            <div class="col-lg-6">
              <img
                src="./img/events/event-birthday.jpg"
                class="img-fluid"
                alt=""
              />
            </div>
          ...
          <div class="row event-item">
            <div class="col-lg-6">
              <img
                src="./img/events/event-private.jpg"
                class="img-fluid"
                alt=""
              />
            </div>
          ...
          <div class="row event-item">
            <div class="col-lg-6">
              <img
                src="./img/events/event-custom.jpg"
                class="img-fluid"
                alt=""
              />
            </div>
              ...
              <div class="ft-quick-links">
                ...
                <div class="link d-md-flex text-white">
                  ...
                  <ul>
                    ...
                    <li class="list-unstyled">
                      <a href="#"> <i class="fa fa-angle-right"></i>Kitchen </a>
                    </li>
                    <li class="list-unstyled">
